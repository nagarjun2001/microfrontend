...
//           <Link to="/uploadvideo">
//             <button
//               className="bg-indigo-500 text-white px-3 py-2 rounded-lg shadow-lg hover:bg-blue-600 transition-colors duration-300"
//             >
//               Upload Video
//             </button>
//           </Link>
          ...
          <div className="grid p-12 rounded-2xl grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {videos.length === 0 ? (
              <>
                <p className="text-gray-600 font-bold text-center col-span-3">You haven't uploaded any videos... Upload Now!!!</p>
                <img 
                  src="https://cdni.iconscout.com/illustration/premium/thumb/video-error-illustration-download-in-svg-png-gif-file-formats--connection-page-404-failure-pack-seo-web-illustrations-6905777.png?f=webp" 
                  className="ml-80 mb-20 text-gray-600 font-bold text-center col-span-3"
                  alt="No videos" 
                />
              </>
              ...
              videos.map((video) => (
                <div
                  key={video.id}
                  className="border shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl cursor-pointer bg-white border border-gray-300 rounded-xl shadow-lg"
                  onClick={() => handleThumbnailClick(video.id)}
                >
                  <div className="relative bg-gray-900">
                    <img
