...
//                                             name={field.name}
//                                             type={field.type}
//                                             className="bg-gray-50 w-full text-gray-700 text-sm px-4 py-3 rounded-md border border-gray-300 focus:border-black-500  focus:ring-black-200 transition duration-150 ease-in-out"
